...
% Set 2D parameters
na = 15;      % Set na = number of flash angles for 2D.
if (na > 1)
    dtheta2D = (28*pi/180)/(na-1);
    startAngle = -28*pi/180/2;
else
    dtheta2D = 0;
    startAngle=0;
...
Resource.ImageBuffer(1).numFrames = ne;
...
Resource.DisplayWindow(1).numFrames = ne;
