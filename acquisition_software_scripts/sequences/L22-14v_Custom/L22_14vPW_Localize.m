...
Trans.frequency = 15.625; % Central frequency actually 13.8 MHz
...
TW.type = 'parametric';
TW.Parameters = [15, 0.67, 3, 1];   % 18 MHz center frequency, 67% pulsewidth 1.5 cycle burst
...
EF(1).Function = text2cell('%customimage');
...
figure(3); clf; imagesc(abs(IQData));
colormap gray
colorbar
