...
close all
clear all
folder = 'D:\Data\20190425\';

fileA ={'IQdata_24-April-2019_16-00-18.mat';
    'IQdata_24-April-2019_15-36-21.mat';
    'IQdata_24-April-2019_15-12-32.mat';
    'IQdata_24-April-2019_14-40-34.mat';
    'IQdata_24-April-2019_13-49-26.mat';
    };
...
for i = 1:size(fileA,1)
    ...
    pdiA{i}=10*log10(pdiA{i}(:,:)./max(max(pdiA{i}(:,:))));
end
...
fileF ={'IQdata_24-April-2019_16-00-18_Func.mat';
    'IQdata_24-April-2019_15-36-21_Func.mat';
    'IQdata_24-April-2019_15-12-32_Func.mat';
    'IQdata_24-April-2019_14-40-34_Func.mat';
    'IQdata_24-April-2019_13-49-26_Func.mat';
    };
...
% %             
    ...
    caxis([-25 1]);CAX = caxis; Cbar=[gray(abs(CAX(1)-1)*100);jet(abs(CAX(2)+1)*100)]; colormap(Cbar); 
...
%%
blockF{1} = box(1:15:end-1);
blockF{2} = box(1:15:end-1);
...
for k = 1:size(X,1)
    ...
    for i = 1:size(cthresh,2)
        ...
        set(gca,'ylim',[-50 100]); grid minor; title(['Timecourse: Run ' time{i}]) 
    ...
    for i = 1:size(pdiF{k},1)
        for j = 1:size(pdiF{k},2)
            ...
            for l = 1:size(start,2)
                trial = tmp(start(l)-5:start(l)+10);
                maxtrial(l) = max(trial(6:end));
                meantrial(l) = mean(trial(11:end));
            end
