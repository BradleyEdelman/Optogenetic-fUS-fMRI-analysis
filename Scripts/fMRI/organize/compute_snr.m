function [SNR,tSNR,fmriroi] = compute_snr(Data)
...
% Load segmentation
roifolder = 'D:\Data_Processed\segment_ofUS\fmri_pre_20191205\';
roi = dir(roifolder);
...
%     N = std(squeeze(mean(mean(noise_data))));
    tSNR(i_roi) = S/N;
end
